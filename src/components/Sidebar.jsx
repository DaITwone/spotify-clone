...
export default function Sidebar() {
  ...
  return (
    <div className='w-[22%] h-full p-2 flex-col gap-2 text-white hidden lg:flex '>
      ...
      <div className='bg-[#121212] h-[100%] rounded'>
        ...
        <div className='p-4 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4'>
            ...
            <p className='font-light'>We'll keep you update on new eppisodes</p>
            <button className='px-4 py-2 bg-white text-[15px] font-bold text-black rounded-full mt-4'>Browse podcasts</button>
        </div>
        <div className="flex flex-wrap gap-4 text-gray-400 text-[10px] mt-10 m-6">
